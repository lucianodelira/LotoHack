...
// Função para verificar o status da conexão de internet
...
// Função para exibir a mensagem personalizada offline
function showOfflineMessage() {
    // Cria um elemento overlay para cobrir a tela
    ...
    offlineOverlay.style.backgroundColor = 'rgba(0, 0, 0, 0.8)';
    offlineOverlay.style.display = 'flex';
    offlineOverlay.style.flexDirection = 'column';
    offlineOverlay.style.justifyContent = 'center';
    offlineOverlay.style.alignItems = 'center';
    offlineOverlay.style.zIndex = '10000';
    offlineOverlay.style.color = '#fff';
    offlineOverlay.style.textAlign = 'center';

    // Adiciona a logo
    const logo = document.createElement('img');
    logo.src = '/icons/logo.png'; // Caminho para o seu ícone
    logo.alt = 'Logo do App';
    logo.style.width = '100px';
    logo.style.marginBottom = '20px';
    offlineOverlay.appendChild(logo);

    // Adiciona o título
    const title = document.createElement('h1');
    title.innerText = 'Loto Hack v1';
    offlineOverlay.appendChild(title);

    // Adiciona a mensagem de aviso
    const message = document.createElement('p');
    message.innerText = 'Verifique a sua conexão com a internet, você parece estar offline!';
    message.style.margin = '20px';
    offlineOverlay.appendChild(message);
    ...
    okButton.addEventListener('click', () => {
        offlineOverlay.style.display = 'none'; // Fecha a tela quando o botão for clicado
    });
    offlineOverlay.appendChild(okButton);

    // Adiciona o overlay ao corpo do documento
    document.body.appendChild(offlineOverlay);
}

// Escuta o evento de quando o navegador fica offline
window.addEventListener('offline', showOfflineMessage);

// Escuta o evento de quando o navegador volta a ficar online
window.addEventListener('online', function() {
    const offlineOverlay = document.getElementById('offline-overlay');
    if (offlineOverlay) {
        offlineOverlay.style.display = 'none'; // Remove a mensagem offline quando online
    }
});

// Verifica o status da conexão quando o app carrega
